...
function Array_cycle(num,        // @arg Integer:
                     callback) { // @arg Function(= null):
                                 ...
                                 // @help: Array#cycle
//{@assert
    _if(!Valid.type(num, "Integer") || num < 0, Array.prototype.cycle, "num");
    _if(!Valid.type(callback, "Function/omit"), Array.prototype.cycle, "callback");
//}@assert
...
function Array_delete(value,      // @arg Any:
                      callback) { // @arg Function(= null):
                                  ...
                                  // @help: Array#delete
//{@assert
    _if(!Valid.type(callback, "Function/omit"), Array.prototype.delete, "callback");
//}@assert
...
//{@assert
    _if(!Valid.type(index, "Integer"), Array.prototype.delete_at, "index");
//}@assert
...
//{@assert
    _if(!Valid.type(callback, "Function"), Array.prototype.delete_if, "callback");
//}@assert
...
function Array_first() { // @ret Any:
                         // @help: Array#first
//{@assert
    _if(arguments.length, Array.prototype.first, "num");
//}@assert
...
function Array_last() { // @ret Any:
                        // @help: Array#last
//{@assert
    _if(arguments.length, Array.prototype.last, "num");
//}@assert
...
function String_center(width,     // @arg Integer:
                       padding) { // @arg String(= " "):
                                  // @help: String#center
//{@assert
    _if(!Valid.type(width, "Integer"),       String.prototype.center, "width");
    _if(!Valid.type(padding, "String/omit"), String.prototype.center, "padding");
//}@assert
...
function String_gsub(pattern,   // @arg RegExp:
                     replace) { // @arg String/Function:
                                ...
                                // @help: String#gsub
//{@assert
    _if(!Valid.type(pattern, "RegExp"),          Array.prototype.gsub, "pattern");
    _if(!Valid.type(replace, "String/Function"), Array.prototype.gsub, "replace");
//}@assert
...
function String_ljust(width,     // @arg Integer:
                      padding) { // @arg String(= " "):
                                 ...
                                 // @help: String#ljust
//{@assert
    _if(!Valid.type(width, "Integer"),       String.prototype.ljust, "width");
    _if(!Valid.type(padding, "String/omit"), String.prototype.ljust, "padding");
//}@assert
...
function String_rjust(width,     // @arg Integer:
                      padding) { // @arg String(= " "):
                                 // @help: String#rjust
//{@assert
    _if(!Valid.type(width, "Integer"),       String.prototype.rjust, "width");
    _if(!Valid.type(padding, "String/omit"), String.prototype.rjust, "padding");
//}@assert
...
function String_sub(pattern,   // @arg RegExp:
                    replace) { // @arg String/Function:
                               ...
                               // @help: String#sub
//{@assert
    _if(!Valid.type(pattern, "RegExp"),          Array.prototype.sub, "pattern");
    _if(!Valid.type(replace, "String/Function"), Array.prototype.sub, "replace");
//}@assert
...
function String_scan(pattern,    // @arg RegExp/String:
                     callback) { // @arg Function(= null): callback(value:String/StringArray, index:Integer):void
                                 ...
                                 // @help: String#scan
//{@assert
    _if(!Valid.type(pattern, "RegExp/String"),  String.prototype.scan, "pattern");
    _if(!Valid.type(callback, "Function/omit"), String.prototype.scan, "callback");
//}@assert
...
function Number_upto(max,        // @arg Integer:
                     callback) { // @arg Function: callback(num:Integer, index:Integer array:Array)
                                 // @help: Number#upto
//{@assert
    _if(!Valid.type(max, "Integer"),       Number.prototype.upto, "max");
    _if(!Valid.type(callback, "Function"), Number.prototype.upto, "callback");
//}@assert
...
function Number_step(limit,      // @arg Integer:
                     ...
                     callback) { // @arg Function: callback(num:Integer, index:Integer, array:Array)
                                 // @help: Number#step
//{@assert
    _if(!Valid.type(limit, "Integer"),     Number.prototype.step, "limit");
    _if(!Valid.type(step, "Integer"),      Number.prototype.step, "step");
    _if(!Valid.type(callback, "Function"), Number.prototype.step, "callback");
//}@assert
...
function Number_to_s(radix) { // @arg Integer(= 10): 2 - 36
                              // @help: Number#to_s
//{@assert
    _if(!Valid.type(radix, "Integer/omit"), Number.prototype.to_s, "radix");
//}@assert
...
//}@node
if (global["Ruby"]) {
    global["Ruby_"] = Ruby; // secondary
} else {
    global["Ruby"]  = Ruby; // primary
}
